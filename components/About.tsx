...
const About = () => {
    ...
    // Get translated infoList items
    const translatedInfoList = [
        {
            icon: assets.edu_icon,
            iconDark: assets.edu_icon_dark,
            title: t('about.infoList.education.title'),
            description: t('about.infoList.education.description')
        },
        {
            icon: assets.project_icon,
            iconDark: assets.project_icon_dark,
            title: t('about.infoList.projects.title'),
            description: t('about.infoList.projects.description')
        }
    ];
        ...
        <section id="about" className="py-20 lg:min-h-[92vh] flex items-center justify-center bg-[#1a1b1b] text-white relative overflow-hidden">
            <div className="max-w-3xl lg:max-w-6xl mx-auto px-6 lg:px-8 w-full py-14">
                ...
                <div className={`text-center mb-8 transform transition-all duration-800 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                    <p className="text-sm text-gray-400 uppercase tracking-wide mb-2">{t('about.sectionTitle')}</p>
                    <h2 className="text-3xl lg:text-4xl font-bold mb-3">{t('about.title')}</h2>
                ...
                <div className={`text-center transform transition-all duration-800 delay-600 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
                    ...
                    <h3 className="text-lg font-semibold mb-4">{t('about.toolsSection.title')}</h3>
